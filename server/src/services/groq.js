      ...
      messages: [
        {
          role: "system",
          content:
            `${TASK_PROMPTS[task]} ${targetLanguage} ${tone} Respond using HTML only (no Markdown). Use simple HTML elements: <p>, <ul>, <ol>, <li>, <strong>, <em>, <br>, and <a>. Do not include <script> or inline event handlers.`.trim(),
        },
        {
          role: "user",
