...
### Deployment Options
- **Vercel / Netlify:** Connect your GitHub repo, set the Root Directory to `client`, set the Build Command to `npm run build`, the Output Directory to `dist`, and add `VITE_API_URL` to the Environment Variables.
